...
function Navbar({ showMenu, toggleMenu }) {
  return (
    <div
      id="nav_bg"
      className="md:flex justify-between border-b-2 border-primaryText sticky top-0 z-50 bg-primary-dark"
    >
      <div className="sm:p-5 p-2 w-32 ">
        <Link
          to="home"
          spy={true}
          smooth={true}
      ...
      <div
        ...
        className="text-primaryText mt-2 mr-2 absolute top-2 right-0 sm:hidden"
      >
